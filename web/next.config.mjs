...
export default {
  /* Only `next dev` overrides this, via scripts/dev.mjs — see the note there.
     The build keeps the default so `output: "export"` keeps writing the
     static site to out/, which is what CI publishes. */
